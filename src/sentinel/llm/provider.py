...
from sentinel.llm.base import BasePlanner
from sentinel.llm.huggingface import HuggingFacePlanner
from sentinel.llm.mock import MockPlanner
from sentinel.llm.ollama import OllamaPlanner
...
def get_planner(settings: Settings | None = None, mock: bool = False) -> BasePlanner:
    ...
    if cfg.llm_provider == "ollama":
        return OllamaPlanner(model=cfg.model, base_url=cfg.ollama_base_url)
